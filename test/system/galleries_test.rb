...
class GalleriesTest < ApplicationSystemTestCase
  ...
  test "creating a Gallery" do
    ...
    fill_in "Animation", with: @gallery.animation
    fill_in "Blog", with: @gallery.blog
    fill_in "Graphics", with: @gallery.graphics
    fill_in "Programming", with: @gallery.programming
    fill_in "Ux", with: @gallery.ux
