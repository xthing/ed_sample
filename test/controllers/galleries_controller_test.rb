...
class GalleriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gallery" do
    assert_difference('Gallery.count') do
      post galleries_url, params: { gallery: { animation: @gallery.animation, blog: @gallery.blog, graphics: @gallery.graphics, programming: @gallery.programming, ux: @gallery.ux } }
    end
  ...
  test "should update gallery" do
    patch gallery_url(@gallery), params: { gallery: { animation: @gallery.animation, blog: @gallery.blog, graphics: @gallery.graphics, programming: @gallery.programming, ux: @gallery.ux } }
